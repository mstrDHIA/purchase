...
class _AddSupplierPageState extends State<AddSupplierPage> {
                                ...
                                _buildActionButton('Save', Colors.deepPurpleAccent, () {
                                  if (_formKey.currentState!.validate()) {
                                    final supplierData = {
                                      ...
                                      'status': 'Active', // ou une valeur selon ton formulaire
                                    };
                                    Navigator.of(context).pop(supplierData);
                                  }
                                }),
                                const SizedBox(width: 12),
                                _buildActionButton('Save & add another', Colors.deepPurple.shade200, () {}),
                                const SizedBox(width: 12),
                                _buildActionButton('Cancel', Colors.grey.shade300, () => Navigator.of(context).maybePop(), textColor: Colors.black),
                              ],
                            ),
                          ],
                        ),
  ...
  Widget _buildHeader(BuildContext context) {
    return Row(
      children: [
        const Text("Add New Supplier", style: TextStyle(fontSize: 36, fontWeight: FontWeight.bold)),
        const Spacer(),
        IconButton(
