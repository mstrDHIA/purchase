                    ...
                    : () async {
                        ...
                        try {
                          if (supplier != null && index != null) {
                            await controller.editSupplier(id: supplier.id, name: nameCtrl.text, contactEmail: emailCtrl.text);
                ...
                child: controller.isLoading
                    ...
                    : controller.errorMessage != null
                        ...
                        : SingleChildScrollView(
                            child: Column(
                              children: [
                                // Make the table use the available horizontal space instead of fixed-width cells
                                SizedBox(
                                  width: double.infinity,
                                  child: DataTable(
                                    horizontalMargin: 16,
                                    ...
                                    rows: paginatedFiltered.asMap().entries.map((entry) {
