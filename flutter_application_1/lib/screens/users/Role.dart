                              ...
                              children: [
                                _actionIcon(
                                  ...
                                  onTap: () async {
                                    ...
                                    final roleData = await RoleNetwork().viewRole(roleId);
                                    ...
                                    if (result != null) {
                                      setState(() {
                                        roles[index - 1] = {
                                          ...
                                          'permissions': result['permissions'] ?? roles[index - 1]['permissions'],
                                        };
                                      });
                                      _fetchRoles();
                                    }
                                ...
                                _actionIcon(
                                  ...
                                  onTap: () {
                                    final roleId = role['id'];
                                    // Capture le contexte parent pour le SnackBar
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (roleId == null || roleId is! int) {
                                                ScaffoldMessenger.of(parentContext).showSnackBar(
                                                  SnackBar(
                                                    content: Text('ID invalide (id=$roleId)'),
                                                    backgroundColor: Colors.red,
