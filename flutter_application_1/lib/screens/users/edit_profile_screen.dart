...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> didChangeDependencies() async {
    selectedUser= await userController.getDetailedUser(widget.userId);
    print( "Selected user: ${selectedUser.username}");
    // _nameController.text =  selectedUser.profile?.firstName ?? selectedUser.firstName;
    // _lastNameController.text =  selectedUser.profile?.lastName ?? selectedUser.lastName;
    // _emailController.text =  selectedUser.email;
    // _usernameController.text =  selectedUser.username;
    // // _us
    // _roleController.text = selectedUser.role?.name ?? "Member";
